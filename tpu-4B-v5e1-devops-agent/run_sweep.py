...
for c in concurrencies:
    for ctx in contexts:
        ...
        try:
            ...
            cmd = f"vllm bench serve --host 35.204.78.225 --port 8000 --model google/gemma-4-E4B-it --dataset-name random --num-prompts {num_prompts} --random-input-len {ctx} --random-output-len 100 --max-concurrency {c}"
