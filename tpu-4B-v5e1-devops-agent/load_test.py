...
async def main():
    ...
    parser.add_argument(
        "--model", type=str, default="google/gemma-4-E4B-it", help="The model to use for the load test."
    )
    parser.add_argument(
        "--prompt",
        type=str,
        default="Explain the architecture of TPU v5e (v5litepod) and why it is optimized for JAX.",
