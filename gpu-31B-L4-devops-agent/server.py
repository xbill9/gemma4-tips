...
DEFAULT_SERVICE_NAME = "gpu-31b-l4-devops-agent"
...
def get_vllm_endpoint(service_name: str = DEFAULT_SERVICE_NAME) -> Optional[str]:
    ...
    Args:
        service_name: The Cloud Run service name to describe (defaults to 'gpu-31b-l4-devops-agent').
    """
...
def get_huggingface_model_copy_instructions(
    ...
    Args:
        repo_id: The Hugging Face repo ID (e.g., 'google/gemma-4-31B-it').
