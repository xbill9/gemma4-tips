...
*   **Service Name:** `vllm-gemma-4-e4b-it`
*   **Service URL:** `https://vllm-gemma-4-e4b-it-289270257791.us-east4.run.app`
*   **Region:** `us-east4`
*   **Hardware:** 
    *   **GPU:** 1x NVIDIA L4
    *   **vCPU:** 4
...
```bash
export VLLM_BASE_URL="https://vllm-gemma-4-e4b-it-289270257791.us-east4.run.app"
...
```bash
gcloud beta run deploy vllm-gemma-4-e4b-it \
