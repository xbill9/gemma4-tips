...
* [vLLM Speculative Decoding MTP Docs](https://docs.vllm.ai/en/latest/features/speculative_decoding/mtp/)
...
The self-hosted **Gemma 4 12B QAT** model (`google/gemma-4-12B-it-qat-w4a16-ct`) was benchmarked on a single **NVIDIA L4 GPU** (Cloud Run Gen2) across a 2D grid of concurrency levels (1 to 2048 concurrent users) and context sizes (8 to 16,384 tokens):
