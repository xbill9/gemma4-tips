...
def generate_charts():
    standard_csv = "/home/xbill/gemma4-tips/gpu-12B-6000-devops-agent/benchmark_sweep_results.csv"
    ...
    plt.savefig("/home/xbill/gemma4-tips/gpu-12B-6000-devops-agent/throughput_comparison.png", dpi=300)
    plt.close()
    ...
    plt.tight_layout(rect=(0, 0.03, 1, 0.90))
    plt.savefig("/home/xbill/gemma4-tips/gpu-12B-6000-devops-agent/latency_comparison.png", dpi=300)
    plt.close()
    ...
    plt.tight_layout(rect=(0, 0.03, 1, 0.90))
    plt.savefig("/home/xbill/gemma4-tips/gpu-12B-6000-devops-agent/success_rate_comparison.png", dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("/home/xbill/gemma4-tips/gpu-12B-6000-devops-agent/context_scaling_comparison.png", dpi=300)
    plt.close()
