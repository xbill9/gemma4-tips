...
def parse_and_plot():
    ...
    plt.title("Gemma 4 2B (TPU v6e-4) Serving Throughput\nConcurrency vs Context Window (req/s)", fontsize=14, fontweight="bold", pad=15)
    ...
    plt.title("Gemma 4 2B (TPU v6e-4) Average Latency\nConcurrency vs Context Window (seconds)", fontsize=14, fontweight="bold", pad=15)
    plt.ylabel("Concurrency (Users)", fontsize=12)
    plt.xlabel("Context Window Length (Tokens)", fontsize=12)
    plt.tight_layout()
