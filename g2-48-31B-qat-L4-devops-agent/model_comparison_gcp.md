...
| Feature / Metric | Gemma 4 (4B) | Gemma 4 (12B Standard) | Gemma 4 (12B QAT) | Gemma 4 (31B) |
| :--- | :--- | :--- | :--- | :--- |
| **Model ID** | `google/gemma-4-E4B-it` | `google/gemma-4-12B-it` | `google/gemma-4-12B-it-qat-w4a16-ct` | `google/gemma-4-31B-it` |
...
> 2. The 31B benchmark was run with a fixed request count of 20 prompts per concurrency level. Therefore, concurrency levels above 16 did not actually test parallel loads beyond 20 concurrent requests, resulting in a flat performance line. 
