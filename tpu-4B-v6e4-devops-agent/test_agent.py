...
class TestDevOpsAgent(unittest.IsolatedAsyncioTestCase):
    def test_model_name_default(self):
        ...
        self.assertEqual(MODEL_NAME, "google/gemma-4-E4B-it")
    ...
    async def test_get_vllm_deployment_config(self, mock_run_command, mock_get_secret):
        ...
        config = await get_vllm_deployment_config(service_name="test-vllm", model_name="google/gemma-4-E4B-it")
        ...
        self.assertIn("google/gemma-4-E4B-it", config)
