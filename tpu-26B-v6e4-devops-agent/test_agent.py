...
class TestDevOpsAgent(unittest.IsolatedAsyncioTestCase):
    def test_model_name_default(self):
        ...
        self.assertEqual(MODEL_NAME, "hugg1ngfac3/gemma-4-26B-A4B-it-FP8")
    ...
    async def test_get_vllm_deployment_config(self, mock_run_command, mock_get_secret):
        ...
        config = await get_vllm_deployment_config(
            service_name="test-vllm", model_name="hugg1ngfac3/gemma-4-26B-A4B-it-FP8"
        )
        ...
        self.assertIn("hugg1ngfac3/gemma-4-26B-A4B-it-FP8", config)
